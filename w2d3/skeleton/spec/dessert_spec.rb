...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect {Dessert.new('', 5.5, chef)}.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    ...
    it "shuffles the ingredient array" do
      expect(dessert.ingredients).not_to eq(%w[flour eggs sugar cocoa])
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve.include?("Chef Jeff the Great Baker")).to be true
    end
  end
